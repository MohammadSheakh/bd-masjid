...
const TIME_MESSAGE =
  'Time must be in 24-hour HH:mm format (e.g., "05:15", "13:30")';

export class UpdatePrayerScheduleDto {
  @ApiPropertyOptional({
    example: '04:45',
    description: 'Fajr start time (HH:mm)',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    example: '12:05',
    description: 'Zuhr start time (HH:mm)',
  })
  @IsOptional()
  @IsString()
  @Matches(TIME_REGEX, { message: TIME_MESSAGE })
  ...
  @ApiPropertyOptional({
    example: '16:15',
    description: 'Asr start time (HH:mm)',
  })
  @IsOptional()
  @IsString()
  @Matches(TIME_REGEX, { message: TIME_MESSAGE })
  ...
  @ApiPropertyOptional({
    example: '18:10',
    description: 'Maghrib start time (HH:mm)',
  })
  @IsOptional()
  @IsString()
  @Matches(TIME_REGEX, { message: TIME_MESSAGE })
  ...
  @ApiPropertyOptional({
    example: '19:30',
    description: 'Isha start time (HH:mm)',
  })
  @IsOptional()
  @IsString()
  @Matches(TIME_REGEX, { message: TIME_MESSAGE })
  ...
  @ApiPropertyOptional({
    example: 'Winter schedule transition',
